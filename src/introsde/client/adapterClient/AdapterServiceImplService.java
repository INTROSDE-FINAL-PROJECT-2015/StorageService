 ...
 * 
 */
@WebServiceClient(name = "AdapterServiceImplService", targetNamespace = "http://ws.adapter.introsde/", wsdlLocation = "http://localhost:6902/ws/adapter?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:6902/ws/adapter?wsdl");
