 ...
 * 
 */
@WebServiceClient(name = "DataBaseServiceImplService", targetNamespace = "http://ws.introsde/", wsdlLocation = "http://localhost:6903/ws/database?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:6903/ws/database?wsdl");
